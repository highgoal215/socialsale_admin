...
import { X, Bell, ArrowRight, Loader2, Trash2, Check } from "lucide-react";
...
export const NotificationPanel = ({ onClose }: NotificationPanelProps) => {
  ...
  return (
    <motion.div
      ...
      className="absolute right-4 top-16 w-80 md:w-96 bg-background border rounded-lg shadow-lg z-20 max-h-[600px] overflow-hidden"
    >
